...
| Admin 帳號 | `redacted@example.com` |
| Admin 密碼 | `REDACTED_ADMIN_PWD` |
| DB | `odoo` (PostgreSQL) |
| Odoo 版本 | 18.0 |
| 已安裝模組 | 163 個 |
| 聯絡人數 | 588 |
...
setup('authenticate as admin', async ({ page }) => {
  ...
  await page.fill('input[name="login"]', 'redacted@example.com');
  await page.fill('input[name="password"]', 'REDACTED_ADMIN_PWD');
