...
(function () {
    var DARK_CSS = [
        ...
        '.o_cc, .o_cc1, .o_cc2, .o_cc3, .o_cc4, .o_cc5 { background: transparent !important; }',
        '.shadow-sm { box-shadow: none !important; }',
        '',
        '/* Send button — Retrodandy */',
        ...
        '',
        '/* NUCLEAR text color — override ALL elements including Bootstrap utilities */',
        '*, *::before, *::after { color: rgba(255,255,255,0.85) !important; }',
        '.text-muted, .text-muted.opacity-75, span.text-muted, .smaller.text-muted { color: rgba(255,255,255,0.45) !important; opacity: 1 !important; }',
        '.opacity-75 { opacity: 1 !important; }',
        'a { color: rgba(255,255,255,0.6) !important; }',
        'a:hover { color: #fff !important; }',
        '',
        '/* Message content */',
        '.o-mail-Message { border-color: rgba(255,255,255,0.15) !important; background: transparent !important; }',
        '.o-mail-Message-body, .o-mail-Message-body p { color: #fff !important; }',
        '.o-mail-Message-author, .o-mail-Message-date, .o-xsmaller { color: rgba(255,255,255,0.5) !important; }',
        '.o-mail-Message-actions .btn, .o-mail-Message .btn { color: rgba(255,255,255,0.4) !important; }',
        '.o-mail-Message-actions .btn:hover { color: #fff !important; }',
        '',
        '/* Date separator ("今天") */',
        '.o-mail-DateSection { color: rgba(255,255,255,0.5) !important; }',
        '.o-mail-DateSection .text-muted { color: rgba(255,255,255,0.5) !important; }',
        '.o-mail-DateSection hr, hr { border-color: rgba(255,255,255,0.15) !important; }',
        '',
        '/* Message highlight/bubble — remove green/colored bg */',
        '.o-mail-Message-bubble, .o-mail-Message-content { background: transparent !important; }',
        '.o-mail-Message .bg-success-light, .o-mail-Message [class*="bg-"] { background: rgba(255,255,255,0.05) !important; }',
        '',
        '/* Borders */',
